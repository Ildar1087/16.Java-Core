...
public class Krestiki_Noliki {
    ...
    private static final char DOT_EMPTY = '*';  // значение по умолчанию в игровом поле
    private static final Scanner scanner = new Scanner(System.in);
    private static final Random random = new Random();
    private static char[][] field; // сюда складываем значения комбинаций
    ...
    static void printField(){
        ...
        for (int x = 0; x < fieldSizeX; x++){
            ...
            // отрисовка ---------- между выводами игрового поля
        for (int i = 1; i < fieldSizeX * fieldSizeY ; i++){
            System.out.print("-");
        }
        System.out.println();
    }
